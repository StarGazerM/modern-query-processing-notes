...
| 3 · Sep. 14–18 | From CQs to binary joins | [Conversation 1.3](03-the-plan-that-meant-the-same-thing.html) and [Conversation 2.1](04-the-order-logic-did-not-choose.html): translate valuation semantics into SPJR, choose a binary join tree, and expose nested-loop and hash-join state | **Rust conversation:** [R.2](rust-02-the-arithmetic-that-ran-before-the-program.html); map written syntax into a derived AST and evaluate it during expansion | Garcia-Molina, Ullman, and Widom, [Database System Implementation](https://i.stanford.edu/~ullman/dbsi.html), selected §§6.2–6.4 |
